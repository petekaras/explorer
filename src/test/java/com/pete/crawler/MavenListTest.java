...
public class MavenListTest extends POMTests{
  ...
  public void setUp() {
    ...
    mavenList = new MavenList(mockPomdao);
  ...
  public void shouldReturnFromArtifactIdSearch() throws Exception{
    ...
    List<ProjectSummary> poms = mavenList.getArtifactsById("anything-as-the-return-mocked");
